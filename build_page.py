...
<p style="color:var(--mut);font-size:12.5px;margin:10px 0 0">Run out and want more? Rewrite the title + first paragraph and re-post to a <b>bonus platform</b>: Telegraph (telegra.ph), Write.as, WordPress.com, Blogger, Rentry. Never post the same text twice.</p></div>
